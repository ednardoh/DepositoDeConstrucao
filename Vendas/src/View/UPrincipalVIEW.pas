...
uses UPedidoDeVendaVIEW, UConexaoBDpas, uCadClientesVIEW, uCadProdutosVIEW,
  uEntradaProdutoVIEW, uLoginVIEW, uRelVendasdiariasVIEW;
...
begin
  pn_empresa.Caption  := ' Empresa : Despósito de Construção ';
  pn_data.Caption     := 'Data : ' + FormatDateTime('DD/MM/YYYY',Now);
  pn_Mensagem.Caption := 'Sistema de Gerenciamento de Estoque para depósito de construção.  ';
